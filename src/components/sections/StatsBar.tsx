...
export async function StatsBar() {
  ...
  const stats = [
    { cle: 'heures', valeur: t('heures_valeur'), label: t('heures_label') },
    { cle: 'disciplines', valeur: t('disciplines_valeur'), label: t('disciplines_label') },
    { cle: 'sites', valeur: t('sites_valeur'), label: t('sites_label') },
    { cle: 'mandats', valeur: t('mandats_valeur'), label: t('mandats_label') },
  ]
