/**
 * Icônes du dashboard Mission NERF — traits simples, `currentColor`, jamais
 * les icônes du site vitrine (Icones.tsx de components/ui) : identité
 * propre à cet écran, voir la docstring de dashboard/page.tsx.
 */
