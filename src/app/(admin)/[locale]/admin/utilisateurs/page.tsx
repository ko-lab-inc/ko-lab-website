    ...
    <>
      ...
      <ListeProfils
        ...
        libellesOrigine={{
          ...
          renvoyer: t('renvoyer_invitation'),
          renvoiEnCours: t('en_cours'),
          renvoiTitre: t('renvoi_invitation_titre'),
          renvoiTexte: t('renvoi_invitation_texte'),
          renvoiCourrielEchecTitre: t('renvoi_invitation_courriel_echec_titre'),
          renvoiCourrielEchecTexte: t('renvoi_invitation_courriel_echec_texte'),
          ...
          erreurRenvoiIntrouvable: t('erreur_renvoi_introuvable'),
          erreurRenvoiPasInvite: t('erreur_renvoi_pas_invite'),
          erreurRenvoiDejaActif: t('erreur_renvoi_deja_actif'),
          erreurRenvoiTentatives: t('erreur_invitation_tentatives'),
          erreurRenvoiServeur: t('erreur_invitation_serveur'),
        }}
        actionInvitation={
          <ModaleInvitation
            locale={locale}
